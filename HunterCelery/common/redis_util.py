...
class RedisManage(object):
    ...
    def get_redis_pool(cls):
        ...
        if not hasattr(RedisManage, "__redis_pool") or not RedisManage.__redis_pool:
            RedisManage.__redis_pool = redis.ConnectionPool(host=redis_host, port=redis_port, password=redis_password,
...
if __name__ == "__main__":
    print(RedisManage.get_redis_client().get('task_id1'))
"""
